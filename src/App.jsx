//Check if user owns membership NFT
//Add mint button
...
import { UnsupportedChainError } from "@web3-react/core";
...
const App = () => {
 ...
 // isClaiming lets us easily keep a loading state while the NFT is minting.
  ...
  useEffect(() => {
    ...
    //a simple call to grab all proposals
    voteModule
      .getAll()
      .then((proposals) => {
        // set state!
...
if (hasClaimedNFT) {return (
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free FrenchieDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
